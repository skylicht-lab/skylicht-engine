// File Generated by Assets/BuildShader.py - source: [SGAreaLightFS.d.hlsl : SHADOW,HARD_SHADOW]
...
float shadowSimple(const float4 shadowCoord)
{
	...
	return (step(depth, uShadowMap.SampleLevel(uShadowMapSampler, uv, 0).r));
}
