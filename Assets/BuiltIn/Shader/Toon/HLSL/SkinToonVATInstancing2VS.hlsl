...
VS_OUTPUT main(VS_INPUT input)
{
	...
	// Vertex id
	uv.x = input.data.y / uTextureSize.x;

	// ANIMATION 1 (frame + clipOffset)
	uv.y = (input.uBoneLocation.x + input.uBoneLocation.y) / uTextureSize.y;
	...
	uv.y = (input.uBoneLocation.z + input.uBoneLocation.w) / uTextureSize.y;
