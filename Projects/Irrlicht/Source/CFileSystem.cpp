...
#include "irrList.h"
	...
	#include <tchar.h>
#else
	#if (defined(_IRR_POSIX_API_) || defined(_IRR_OSX_PLATFORM_) || defined(ANDROID) || defined(LINUX)) || defined(_IRR_IOS_PLATFORM_)
		#include <stdio.h>
		#include <stdlib.h>
		#include <string.h>
		#include <limits.h>
...
const io::path& CFileSystem::getWorkingDirectory()
{
	...
	else
	{
		...
		// does not need this
		#elif defined(_IRR_WINDOWS_API_) && !defined(CYGWIN)
...
io::path CFileSystem::getAbsolutePath(const io::path& filename) const
{
	...
	#endif
	return tmp;
#elif defined(_IRR_POSIX_API_) || defined(CYGWIN) || defined(_IRR_OSX_PLATFORM_) || defined(_IRR_IOS_PLATFORM_)
	c8* p=0;
	c8 fpath[4096];
	fpath[0]=0;
...
IFileList* CFileSystem::createFileList()
{
	...
	if (FileSystemType == FILESYSTEM_NATIVE)
	{
		...
		#if !defined(CYGWIN)
		// TODO: createFileList do not support on Cygwin
		...
		// --------------------------------------------
		//! Linux version
		#if (defined(_IRR_POSIX_API_) || defined(_IRR_OSX_PLATFORM_)) || defined(IOS) || defined(ANDROID)
