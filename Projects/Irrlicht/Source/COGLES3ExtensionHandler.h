...
#ifndef __C_OGLES3_EXTENSION_HANDLER_H_INCLUDED__
#define __C_OGLES3_EXTENSION_HANDLER_H_INCLUDED__
...
namespace irr
{
	...
	{
		class COGLES3Driver;
		class COGLES3ExtensionHandler
		{
		public:
			enum EOGLES3Features
			{
			...
			bool queryOpenGLFeature(EOGLES3Features feature) const
			{
		...
		public:
			...
			bool StencilBuffer;
			bool FeatureAvailable[IRR_OGLES3_Feature_Count];
		};
