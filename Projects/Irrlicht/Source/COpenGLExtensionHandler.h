...
class COpenGLExtensionHandler
{
	...
	void extGlTexImage3D(GLenum target,
		GLint level,
	...
	void extGlTexSubImage3D(GLenum target,
		GLint level,
		GLint xoffset,
		GLint yoffset,
		GLint zoffset,
	...
	void extGlCompressedTexImage3D(GLenum target,
		GLint level,
	...
	void extGlCompressedTexSubImage3D(GLenum target,
		GLint level,
		GLint xoffset,
		GLint yoffset,
		GLint zoffset,
	...
	void extGlTexStorage3D(GLenum target,
		GLsizei levels,
		GLenum internalformat,
		GLsizei width,
		GLsizei height,
	...
	void extGlFramebufferTextureLayer(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
	...
	void extGlDrawElementsInstanced(GLenum mode,
		GLsizei count,
		GLenum type,
		const void * indices,
		GLsizei primcount);
...
inline void COpenGLExtensionHandler::extGlTexImage3D(GLenum target,
	GLint level,
	GLint internalFormat,
	GLsizei width,
	GLsizei height,
...
inline void COpenGLExtensionHandler::extGlTexSubImage3D(GLenum target,
	GLint level,
	GLint xoffset,
	GLint yoffset,
	GLint zoffset,
...
#else
	os::Printer::log("glTexSubImage3D not supported", ELL_ERROR);
#endif
}

inline void COpenGLExtensionHandler::extGlCompressedTexImage3D(GLenum target,
	GLint level,
	GLenum internalformat,
	GLsizei width,
	GLsizei height,
...
{
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
	if (pGlCompressedTexImage3D)
		pGlCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
#elif defined(GL_ARB_texture_compression)
	glCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
#else
	os::Printer::log("glCompressedTexImage3D not supported", ELL_ERROR);
#endif
}


inline void COpenGLExtensionHandler::extGlCompressedTexSubImage3D(GLenum target,
	GLint level,
	GLint xoffset,
	GLint yoffset,
	GLint zoffset,
...
#else
	os::Printer::log("glCompressedTexSubImage3D not supported", ELL_ERROR);
#endif
}

inline void COpenGLExtensionHandler::extGlTexStorage3D(GLenum target,
	GLsizei levels,
	GLenum internalformat,
	GLsizei width,
	GLsizei height,
...
#else
	os::Printer::log("glTexStorage3D not supported", ELL_ERROR);
#endif
}
...
inline void COpenGLExtensionHandler::extGlFramebufferTextureLayer(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer)
{
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
	if (pGlFramebufferTextureLayer)
