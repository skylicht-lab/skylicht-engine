...
void COpenGLExtensionHandler::initExtensions(bool stencilBuffer)
{
	...
	pGlTexImage3D = (PFNGLTEXIMAGE3DPROC)IRR_OGL_LOAD_EXTENSION("glTexImage3D");
	pGlTexSubImage3D = (PFNGLTEXSUBIMAGE3DPROC)IRR_OGL_LOAD_EXTENSION("glTexSubImage3D");
	pGlCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3DPROC)IRR_OGL_LOAD_EXTENSION("glCompressedTexImage3D");
	...
	// instancing
	pGlVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORPROC)IRR_OGL_LOAD_EXTENSION("glVertexAttribDivisor");
	pGlDrawElementsInstanced = (PFNGLDRAWELEMENTSINSTANCEDPROC)IRR_OGL_LOAD_EXTENSION("glDrawElementsInstanced");
